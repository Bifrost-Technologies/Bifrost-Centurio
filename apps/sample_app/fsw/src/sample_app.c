...
CFE_Status_t SAMPLE_APP_Init(void)
{
    ...
    */
    ...
    else
    {
        ...
        /* Initialize nav/status defaults */
        SAMPLE_APP_Data.Nav.LatitudeDeg  = 37.6213;   /* example: SFO lat */
        SAMPLE_APP_Data.Nav.LongitudeDeg = -122.3790; /* example: SFO lon */
        SAMPLE_APP_Data.Nav.AltitudeM    = 10.0f;
        SAMPLE_APP_Data.Nav.VelNorthMS   = 0.0f;
        SAMPLE_APP_Data.Nav.VelEastMS    = 0.0f;
        SAMPLE_APP_Data.Nav.VelDownMS    = 0.0f;
        SAMPLE_APP_Data.Nav.YawDeg       = 0.0f;
        SAMPLE_APP_Data.Nav.PitchDeg     = 0.0f;
        SAMPLE_APP_Data.Nav.RollDeg      = 0.0f;
        SAMPLE_APP_Data.Nav.SystemStatus = 1; /* OK */
        SAMPLE_APP_Data.Nav.NavFixType   = 3; /* 3D */
