...
CFE_Status_t SAMPLE_APP_SendHkCmd(const SAMPLE_APP_SendHkCmd_t *Msg)
{
    ...
    */
    ...
    /* Simulate nav/status updates for testing (could be driven by real sensors later) */
    /* Simple deterministic walk for position/orientation */
    SAMPLE_APP_Data.Nav.LatitudeDeg  += 0.0001;  /* ~11m */
    SAMPLE_APP_Data.Nav.LongitudeDeg += 0.0001;  /* ~11m at equator */
    SAMPLE_APP_Data.Nav.YawDeg       += 0.5f;
    if (SAMPLE_APP_Data.Nav.YawDeg > 180.0f)
    {
        SAMPLE_APP_Data.Nav.YawDeg -= 360.0f;
    }

    /* Copy runtime nav/status into HK payload */
    SAMPLE_APP_Data.HkTlm.Payload.LatitudeDeg  = SAMPLE_APP_Data.Nav.LatitudeDeg;
    SAMPLE_APP_Data.HkTlm.Payload.LongitudeDeg = SAMPLE_APP_Data.Nav.LongitudeDeg;
    SAMPLE_APP_Data.HkTlm.Payload.AltitudeM    = SAMPLE_APP_Data.Nav.AltitudeM;
    SAMPLE_APP_Data.HkTlm.Payload.VelNorthMS   = SAMPLE_APP_Data.Nav.VelNorthMS;
    SAMPLE_APP_Data.HkTlm.Payload.VelEastMS    = SAMPLE_APP_Data.Nav.VelEastMS;
    SAMPLE_APP_Data.HkTlm.Payload.VelDownMS    = SAMPLE_APP_Data.Nav.VelDownMS;
    SAMPLE_APP_Data.HkTlm.Payload.YawDeg       = SAMPLE_APP_Data.Nav.YawDeg;
    SAMPLE_APP_Data.HkTlm.Payload.PitchDeg     = SAMPLE_APP_Data.Nav.PitchDeg;
    SAMPLE_APP_Data.HkTlm.Payload.RollDeg      = SAMPLE_APP_Data.Nav.RollDeg;
    SAMPLE_APP_Data.HkTlm.Payload.SystemStatus = SAMPLE_APP_Data.Nav.SystemStatus;
    SAMPLE_APP_Data.HkTlm.Payload.NavFixType   = SAMPLE_APP_Data.Nav.NavFixType;
